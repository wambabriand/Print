...
public class JwtUserPassAuthenticationFilter extends UsernamePasswordAuthenticationFilter{
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			String credentialsString = new String( request.getInputStream().readAllBytes() );
			
			UsernameAndPassword authenticationRequest = new ObjectMapper().readValue(credentialsString,UsernameAndPassword.class);
